...
class SprintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sprint" do
    assert_difference("Sprint.count") do
      post sprints_url, params: { sprint: { name: @sprint.name, project_id: @sprint.project_id } }
    end
  ...
  test "should update sprint" do
    patch sprint_url(@sprint), params: { sprint: { name: @sprint.name, project_id: @sprint.project_id } }
